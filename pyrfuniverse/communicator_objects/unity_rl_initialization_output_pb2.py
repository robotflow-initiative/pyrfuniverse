...
# source: pyrfuniverse/communicator_objects/unity_rl_initialization_output.proto
...
from pyrfuniverse.communicator_objects import capabilities_pb2 as pyrfuniverse_dot_communicator__objects_dot_capabilities__pb2
from pyrfuniverse.communicator_objects import brain_parameters_pb2 as pyrfuniverse_dot_communicator__objects_dot_brain__parameters__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='pyrfuniverse/communicator_objects/unity_rl_initialization_output.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\nFpyrfuniverse/communicator_objects/unity_rl_initialization_output.proto\x12\x14\x63ommunicator_objects\x1a\x34pyrfuniverse/communicator_objects/capabilities.proto\x1a\x38pyrfuniverse/communicator_objects/brain_parameters.proto\"\x8c\x02\n UnityRLInitializationOutputProto\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x1d\n\x15\x63ommunication_version\x18\x02 \x01(\t\x12\x10\n\x08log_path\x18\x03 \x01(\t\x12\x44\n\x10\x62rain_parameters\x18\x05 \x03(\x0b\x32*.communicator_objects.BrainParametersProto\x12\x17\n\x0fpackage_version\x18\x07 \x01(\t\x12\x44\n\x0c\x63\x61pabilities\x18\x08 \x01(\x0b\x32..communicator_objects.UnityRLCapabilitiesProtoJ\x04\x08\x06\x10\x07\x42+\xaa\x02(Robotflow.RFUniverse.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[pyrfuniverse_dot_communicator__objects_dot_capabilities__pb2.DESCRIPTOR,pyrfuniverse_dot_communicator__objects_dot_brain__parameters__pb2.DESCRIPTOR,])
...
_UNITYRLINITIALIZATIONOUTPUTPROTO.fields_by_name['brain_parameters'].message_type = pyrfuniverse_dot_communicator__objects_dot_brain__parameters__pb2._BRAINPARAMETERSPROTO
_UNITYRLINITIALIZATIONOUTPUTPROTO.fields_by_name['capabilities'].message_type = pyrfuniverse_dot_communicator__objects_dot_capabilities__pb2._UNITYRLCAPABILITIESPROTO
...
UnityRLInitializationOutputProto = _reflection.GeneratedProtocolMessageType('UnityRLInitializationOutputProto', (_message.Message,), dict(
  ...
  __module__ = 'pyrfuniverse.communicator_objects.unity_rl_initialization_output_pb2'
