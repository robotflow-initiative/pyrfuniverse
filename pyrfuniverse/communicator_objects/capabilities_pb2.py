...
# source: pyrfuniverse/communicator_objects/capabilities.proto
...
UnityRLCapabilitiesProto = _reflection.GeneratedProtocolMessageType('UnityRLCapabilitiesProto', (_message.Message,), dict(
  ...
  __module__ = 'pyrfuniverse.communicator_objects.capabilities_pb2'
