...
# source: pyrfuniverse/communicator_objects/training_analytics.proto
...
TrainingEnvironmentInitialized = _reflection.GeneratedProtocolMessageType('TrainingEnvironmentInitialized', (_message.Message,), dict(
  ...
  __module__ = 'pyrfuniverse.communicator_objects.training_analytics_pb2'
