...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pyrfuniverse/communicator_objects/unity_rl_initialization_input.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\nEpyrfuniverse/communicator_objects/unity_rl_initialization_input.proto\x12\x14\x63ommunicator_objects\x1a\x34pyrfuniverse/communicator_objects/capabilities.proto\"\xad\x01\n\x1fUnityRLInitializationInputProto\x12\x0c\n\x04seed\x18\x01 \x01(\x05\x12\x1d\n\x15\x63ommunication_version\x18\x02 \x01(\t\x12\x17\n\x0fpackage_version\x18\x03 \x01(\t\x12\x44\n\x0c\x63\x61pabilities\x18\x04 \x01(\x0b\x32..communicator_objects.UnityRLCapabilitiesProtoB+\xaa\x02(Robotflow.RFUniverse.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[pyrfuniverse_dot_communicator__objects_dot_capabilities__pb2.DESCRIPTOR,])
...
_UNITYRLINITIALIZATIONINPUTPROTO.fields_by_name['capabilities'].message_type = pyrfuniverse_dot_communicator__objects_dot_capabilities__pb2._UNITYRLCAPABILITIESPROTO
...
UnityRLInitializationInputProto = _reflection.GeneratedProtocolMessageType('UnityRLInitializationInputProto', (_message.Message,), dict(
  ...
  __module__ = 'pyrfuniverse.communicator_objects.unity_rl_initialization_input_pb2'
