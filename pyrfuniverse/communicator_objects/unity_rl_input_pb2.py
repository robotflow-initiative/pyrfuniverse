...
_UNITYRLINPUTPROTO_LISTAGENTACTIONPROTO.fields_by_name['value'].message_type = pyrfuniverse_dot_communicator__objects_dot_agent__action__pb2._AGENTACTIONPROTO
...
_UNITYRLINPUTPROTO.fields_by_name['command'].enum_type = pyrfuniverse_dot_communicator__objects_dot_command__pb2._COMMANDPROTO
...
UnityRLInputProto = _reflection.GeneratedProtocolMessageType('UnityRLInputProto', (_message.Message,), dict(
  ...
  ListAgentActionProto = _reflection.GeneratedProtocolMessageType('ListAgentActionProto', (_message.Message,), dict(
    ...
    __module__ = 'pyrfuniverse.communicator_objects.unity_rl_input_pb2'
