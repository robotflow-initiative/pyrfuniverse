...
_BRAINPARAMETERSPROTO.fields_by_name['vector_action_space_type_deprecated'].enum_type = pyrfuniverse_dot_communicator__objects_dot_space__type__pb2._SPACETYPEPROTO
...
ActionSpecProto = _reflection.GeneratedProtocolMessageType('ActionSpecProto', (_message.Message,), dict(
  ...
  __module__ = 'pyrfuniverse.communicator_objects.brain_parameters_pb2'
