...
# source: pyrfuniverse/communicator_objects/unity_rl_output.proto
...
_UNITYRLOUTPUTPROTO_LISTAGENTINFOPROTO.fields_by_name['value'].message_type = pyrfuniverse_dot_communicator__objects_dot_agent__info__pb2._AGENTINFOPROTO
...
UnityRLOutputProto = _reflection.GeneratedProtocolMessageType('UnityRLOutputProto', (_message.Message,), dict(
  ...
  ListAgentInfoProto = _reflection.GeneratedProtocolMessageType('ListAgentInfoProto', (_message.Message,), dict(
    ...
    __module__ = 'pyrfuniverse.communicator_objects.unity_rl_output_pb2'
