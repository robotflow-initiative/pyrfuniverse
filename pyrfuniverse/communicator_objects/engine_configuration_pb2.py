...
# source: pyrfuniverse/communicator_objects/engine_configuration.proto
...
EngineConfigurationProto = _reflection.GeneratedProtocolMessageType('EngineConfigurationProto', (_message.Message,), dict(
  ...
  __module__ = 'pyrfuniverse.communicator_objects.engine_configuration_pb2'
