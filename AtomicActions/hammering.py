...
if __name__ == '__main__':
    ...
    env.step('right', np.array([0.85, 0.9, 0.7]),
    ...
    env.step('right', np.array([0.444999993, 0.71, 0.67]), p.getQuaternionFromEuler([pi / 2, pi / 2, 0]))
    env.step('right', np.array([0.444999993, 0.67, 0.67]), p.getQuaternionFromEuler([pi / 2, pi / 2, 0]))
    env.step('right', np.array([0.444999993, 0.71, 0.67]), p.getQuaternionFromEuler([pi / 2, pi / 2, 0]))
    env.step('right', np.array([0.444999993, 0.67, 0.67]), p.getQuaternionFromEuler([pi / 2, pi / 2, 0]))
    env.step('right', np.array([0.444999993, 0.71, 0.67]), p.getQuaternionFromEuler([pi / 2, pi / 2, 0]))
    env.step('right', np.array([0.444999993, 0.67, 0.67]), p.getQuaternionFromEuler([pi / 2, pi / 2, 0]))
