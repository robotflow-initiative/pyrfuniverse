...
if __name__ == "__main__":
    ...
    env.step(
        "left",
        np.array([-0.319999993, 1.3, 1.1000005]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    env.close_gripper("left")
    env.step(
        "left",
        np.array([-0.319999993, 1.3, 1.0]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    env.open_gripper("left")
    env.step(
        "left",
        np.array([-0.319999993, 1.09619999, 0.8]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    ...
    env.step(
        "left",
        np.array([-0.319999993, 1.09619999, 1.1000005]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    env.close_gripper("left")
    env.step(
        "left",
        np.array([-0.319999993, 1.09619999, 0.95]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    env.open_gripper("left")
    env.step(
        "left",
        np.array([-0.319999993, 0.930000007, 0.8]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    ...
    env.step(
        "left",
        np.array([-0.319999993, 0.930000007, 1.1000005]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    env.close_gripper("left")
    env.step(
        "left",
        np.array([-0.319999993, 0.930000007, 0.9]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    ...
    env.step(
        "left",
        np.array([-0.319999993, 1.28, 1.0]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
    env.close_gripper("left")
    env.step(
        "left",
        np.array([-0.319999993, 1.28, 1.1000005]),
        orientation=p.getQuaternionFromEuler([0, 0, 0]),
    )
