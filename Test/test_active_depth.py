...
# ir_intrinsic_matrix = [920, 0, 0, 0., 920, 0, 640, 360, 1]
...
point1 = dp.image_array_to_point_cloud_intrinsic_matrix(image_rgb, image_active_depth, nd_main_intrinsic_matrix,
...
nd_main_intrinsic_matrix = np.reshape(main_intrinsic_matrix, [3, 3]).T
# point = dp.image_array_to_point_cloud(image_rgb, image_active_depth, 45, local_to_world_matrix)
point2 = dp.image_array_to_point_cloud_intrinsic_matrix(image_rgb, image_active_depth, nd_main_intrinsic_matrix,
                                                        local_to_world_matrix)
